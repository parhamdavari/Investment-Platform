              ...
              <nav className="navbar navbar-expand-lg">
                ...
                <div className="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                  <ul id="nav" className="navbar-nav ml-auto">
                    ...
                    <li className="nav-item">
                      <a className="page-scroll" href="https://tronscan.org/#/contract/TMnJoDqoVCUkjhi5yRLM3eupfhBHXzfrsA/code">CONTRACT[Verified]</a>
                    </li>
                  </ul>
                </div> {/* navbar collapse */}
        ...
        <div className="row justify-content-center">
          <div className="col-lg-8">
            <div className="header-hero-content text-center mt-100">
              ...
              <h1 className="header-title wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.5s">GET UP 30% DAILY INTEREST</h1>
